...
export default class NavBar extends React.PureComponent {
  ...
  state={
    ...
    primColor: Colors.primary,
    selectedIconColor: Colors.third,
    mainOffSetIos:20,
    mainOffSetAndroid:0
  }
  ...
  componentDidMount(){
    ...
    this.setState({
      icon1: 'library',
      icon2: 'md-star',
      icon3: 'md-add-circle-outline',
      icon4: 'ios-checkmark-circle-outline',
      icon5: 'ios-cog',
      iconColor: 'black',
      primColor: Colors.primary,
      selectedIconColor: Colors.third,
  ...
  render(){
    ...
    let off=(Platform.OS==='ios')?height:height+5
    if(this.props.mainOffSetAndroid)
      off=(Platform.OS==='ios')?height:height+5-this.props.mainOffSetAndroid
    if(this.props.mainOffSetIos)
      off=(Platform.OS==='ios')?height-this.props.mainOffSetIos:height+5
    return(
      <View style={{position:'absolute',top:off}}>
        <View 
          style={{backgroundColor:this.state.primColor,position:'absolute',width:width,height:83,bottom:30+yoffset,
          shadowColor: Colors.secondary,shadowOffset: {width: 1,height: 4},shadowOpacity: 0.5,shadowRadius: 10,}}>
        </View> 
        ...
        <Animated.View style={{position:'absolute',bottom:0,left:navrr}}>
          ...
          <View style={{backgroundColor:Colors.third,position:'absolute',
            bottom:0+yoffset,
            right:100,
            width:width,
            height:100,
          ...
          <View style={{backgroundColor:Colors.third,position:'absolute',
            bottom:0+yoffset,
            right:Platform.OS==='ios'? -width + 69:-343,
            width:width,
            height:100,
            borderRadius:40
          }}></View>
        ...
        <View style={{position:'absolute',bottom:-20,width:width,height:100,flexDirection:'row',justifyContent:'space-around',paddingVertical:20}}>
          ...
          <TouchableOpacity onPressOut={() => this._start(2)} style={{...styles.wicon}} onPress={() => this.props.setModal(true)}>
          ...
          <TouchableOpacity onPressOut={() => this._start(3)} style={{...styles.wicon}} onPress={() => this.props.setModal(true)}>
          ...
          <TouchableOpacity onPressOut={() => this._start(4)} style={{...styles.wicon}} onPress={() => this.props.setModal(true)}>
          ...
          <TouchableOpacity onPressOut={() => this._start(5)} style={{...styles.wicon}} onPress={() => this.props.setModal(true)}>
